...
6. "Deploy" the latest version of the library to one of our environments: `./deploy.sh <env>`, where env is either `dev`, `internal`, or `local` (but see below for how to configure `local`).
